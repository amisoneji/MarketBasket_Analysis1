...
class train_validation:
    ...
    def train_validation(self):
        try:
            ...
            LengthOforderInFile, LengthOfreviewsInFile,LengthOfdatasetInFile, column_names, noofcolumns = self.raw_data.valuesFromSchema()
            # getting the regex defined to validate filename
            regex = self.raw_data.manualRegexCreation()
            # validating filename of prediction files
            self.raw_data.validationFileNameRaw(regex, LengthOforderInFile, LengthOfreviewsInFile,LengthOfdatasetInFile)
